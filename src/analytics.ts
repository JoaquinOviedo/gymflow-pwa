...
export function detectNewRecords(exerciseId: string, sets: ExerciseSet[], previous: PersonalRecord[], date: string, sessionId?: string): PersonalRecord[] {
