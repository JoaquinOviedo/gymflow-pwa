...
export interface RoutineExercise { exerciseId: string; order: number; targetSets: number; repMin: number; repMax: number; restSeconds: number; workSeconds?: number; notes?: string; startingWeight?: number; startingLoad?: string }
